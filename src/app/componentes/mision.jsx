...
const Mision = () => {
  ...
  <div className="flex flex-col md:flex-row justify-between w-[90%] p-6 gap-6">

    <div className="flex flex-col bg-[var(--azul-oscuro)] rounded-2xl p-4 w-full md:w-[48%] place-content-start items-center justify-start">
      <span className="text-white text-[40px] md:text-[80px] mont-regular">Misión</span>
      <span className="mont-regular m-4 text-white text-center text-[14px] md:text-[18px]">
    ...
    <div className="flex flex-col bg-[var(--azul-oscuro)] rounded-2xl p-4 w-full md:w-[48%] place-content-start items-center justify-start">
      <span className="text-white text-[40px] md:text-[80px] mont-regular">Visión</span>
      <span className="mont-regular m-4 text-white text-center text-[14px] md:text-[18px]">
